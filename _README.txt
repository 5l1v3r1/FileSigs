_README.txt (12/13/2015)

In addition to this README file, the ZIP package includes six files:
...
More information about Scalpel, including a copy of the standard scalpel.conf file, can be found at http://www.digitalforensicssolutions.com/Scalpel/.
...
<TrID ver="2.00">
  ...
  <General>
    ...
    <Creator>GCK's convert_sigs v3.4</Creator>
  </General>
  <FrontBlock>
    <Pattern>
